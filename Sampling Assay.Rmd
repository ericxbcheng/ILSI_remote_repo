...
```{r}
lot_decision(data = contam_sp_xy, case = case, m = m, M = M, method_det = method_det, Mc = Mc, spread = "continuous")
lot_decision(data = contam_sp_xy, case = case, m = m, M = M, method_det = method_det, Mc = Mc, spread = "discrete")
```
