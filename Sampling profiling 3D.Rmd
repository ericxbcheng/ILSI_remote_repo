...
profvis(expr = {tune_param(Args = ArgList_Ex1, n_seed = 1, n_iter = 1, param = "c_hat", val = 10)})
...
profvis(expr = {tune_param(Args = ArgList_Ex2, n_seed = 1, n_iter = 1, param = "c_hat", val = 1)})

profvis(expr = {tune_param(Args = ArgList_Ex2, n_seed = 1, n_iter = 1, param = "c_hat", val = 10)})
...
profvis(expr = {tune_param(Args = ArgList_Ex2, n_seed = 10, n_iter = 10, param = "c_hat", val = 1)})
```