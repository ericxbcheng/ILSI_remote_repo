...
plot_sp_cont = sp_draw(method = "strs", data = sp_xy, spread = "continuous", xlim = x_lim, ylim = y_lim, n_strata = n_strata, by = by)
plot_overlay_cont = overlay_draw(method = "strs", data = contam_sp_xy, spread = "continuous", xlim = x_lim, ylim = y_lim, n_strata = n_strata, by = by)
...
```{r, eval= FALSE}
pdf(file = "Sampling Plots STRS.pdf")
  plot_contam_dis
  plot_sp_dis
  plot_overlay_dis
  plot_contam_cont
