...
```{r}
## Add the "cont_level" column to df_sp. Remember, the cont_level for sample points only exist for the continuous spread case, so we should calculate the contamination contributions from contamination spots only.

  sp_xy[["cont_level"]] = NA
  
  ## Generate the combined coordinates of contamination and sample points
  a = rbind(contam_xy, sp_xy)
  rownames(a) = NULL
