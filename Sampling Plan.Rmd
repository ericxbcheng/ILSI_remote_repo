...
6. Calculate the contamination level of the sample points. Combine the `sp_xy` and `contam_xy`.
    ...
    2) Add in sampling error to the sample points, assuming the sampling error follows a log normal distribution with mean = 0 and sd = 1. In the discrete spread scenario, sampling error is only added to the sample points with at least one contamination point. Samples that didn't capture any contamination point will not get sampling error.
