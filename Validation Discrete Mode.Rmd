...
sim_result = sim_outcome_val(c_hat = c_hat, rho = rho, m_kbar = m_kbar,conc_neg = conc_neg, 
                             lims = lims, covar = covar_mat,spread = spread, 
                             n_affected = n_affected,dis_level = dis_level, 
                             seed = seed, n = n, m_sp = m_sp, n_sub = n_sub, 
                             homogeneity = homogeneity, unbalanced = unbalanced)
