  ...
  if(input$spread_vs == "continuous"){
    if(input$geom_vs %in% c("point", "area")){
      verticalLayout(
        ...
        disabled(
          actionButton("Doc_Samplepoints_Sma", "",style = "padding: 5px; margin: 26px 0px 0px 0px;",icon = icon("question-circle") ),
        ...
        actionButton("Doc_SamplingStrat_Sma", "",style = "padding: 5px; margin: 26px 0px 0px 0px;",icon = icon("question-circle") ),
      ...
      verticalLayout(
        actionButton("Doc_Probe", "",style = "padding: 5px; margin: 26px 0px 0px 0px;",icon = icon("question-circle") ),
        p("Q10. What's the diameter of the probe (m)?"),
        numericInput(inputId = "d_vs", label = NULL, value = 0.04, min = 0.01, max = 1, step = 0.01),
        actionButton("Doc_Sampling_s", "",style = "padding: 5px; margin: 26px 0px 0px 0px;",icon = icon("question-circle") ),
        p("Q11. Which sampling strategy would you use?"),
