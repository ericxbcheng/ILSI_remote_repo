...
3. Simulate the contamination center and its spread.
    ...
    c) Generate contamination levels for contamination spots. The contamination levels follow a log normal distribution. The spread of contamination level is defined by an exponential function `f_exp`. This function is affected by distance, `spread_radius` and `LOC`.
