...
3. Simulate the contamination center and its spread.
    ...
    c) Generate contamination levels for contamination spots. The contamination levels follow a log normal distribution ($X\~logN(`r cont_level[1]`, `r cont_level[2]`)$). The spread of contamination level is defined by a decay function. This function is affected by distance, `spread_radius` and `LOC`.
