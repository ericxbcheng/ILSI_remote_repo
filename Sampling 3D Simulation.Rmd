---
title: "Sampling 3D Simulation (hopper car)"
...
# Objective
  ...
  To analyze data from 100 iterations of 3D simulation in a 14m x 3m x 2.5m hopper car (without parallelization).
...
exp1_cleaned = read.csv(file = "sim_14x3x2.5_exp1_4_srsxstrsxss_1x10x100x1000_10x10.csv", header = TRUE, row.names = 1, stringsAsFactors = FALSE)
exp2_cleaned = read.csv(file = "sim_14x3x2.5_exp2_5x10x100_srs_1x10x100x1000_10x10.csv", header = TRUE, row.names = 1, stringsAsFactors = FALSE)
```
