---
title: "Sampling 3D Simulation v1"
...
# Objective
  ...
  To analyze data from 100 iterations of 3D simulation in a 1m x 1m x 1m tote (with parallelization).
...
rds_files = dir(path = paste0(getwd(), "/RDS/3D Simulation"),pattern = "1x1x1", full.names = TRUE)
...
exp1_cleaned = read.csv(file = "sim_1x1x1_exp1_9_srsxstrsxss_1x10x100_10x10_parallel.csv", header = TRUE, row.names = 1, stringsAsFactors = FALSE)
exp2_cleaned = read.csv(file = "sim_1x1x1_exp2_5x10x100_srs_1x10x100_10x10_parallel.csv", header = TRUE, row.names = 1, stringsAsFactors = FALSE)
```
