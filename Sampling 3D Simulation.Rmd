...
test = exp_combined %>%
  dplyr::filter(experiment == 2 & n_sp == 100 & n_affected == 100)
calc_mean_slope(data = test, Mc = Mc, c_hat_vec = c_hat_vec, experiment = 2, n_sp = 100, n_affected = 100)
calc_mean_slope(data = exp_combined, Mc = Mc, c_hat_vec = c_hat_vec, experiment = 2, n_sp = 100, n_affected = 100)
```
