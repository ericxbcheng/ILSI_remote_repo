...
# Objective
  ...
  To analyze data from 100 iterations of 3D simulation in a 1m x 1m x 1m tote (without parallelization).
...
exp1_cleaned = read.csv(file = "sim_1x1x1_exp1_9_srsxstrsxss_1x10x100_100x100.csv", header = TRUE, row.names = 1, stringsAsFactors = FALSE)
exp2_cleaned = read.csv(file = "sim_1x1x1_exp2_5x10x100_srs_1x10x100_100x100.csv", header = TRUE, row.names = 1, stringsAsFactors = FALSE)
```
