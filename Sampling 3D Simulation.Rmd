...
exp1_cleaned = metrics_dis_sec(data = exp1[[1]], vals_prim = c_hat_vec, vals_sec = method_sp_vec, n_seed = n_seed)
...
#   
#   # Combine
#   return(cbind.data.frame(a, param3 = b))
# }
# 
# exp1_cleaned = f_clean_up(data = exp1, vals_prim = c_hat_vec, vals_sec = method_sp_vec, vals_tert = n_affected_vec)
```

```{r, echo = FALSE, message = FALSE}
exp1_cleaned = read_csv(file = "", col_names = TRUE)
exp2_cleaned = read_csv(file = "", col_names = TRUE)
```
