---
title: "Sampling 3D Simulation v3"
...
# Objective
  ...
  To analyze data from 100 iterations of 3D simulation in a 14m x 3m x 2.5m hopper car.
...
rds_files = dir(path = paste0(getwd(), "/RDS/3D Simulation"),pattern = "14x3x2.5", full.names = TRUE)
...
exp1_cleaned = read.csv(file = "sim_14x3x2.5_exp1_4_srsxstrsxss_1x10x100_10x10.csv", header = TRUE, row.names = 1, stringsAsFactors = FALSE)
exp2_cleaned = read.csv(file = "sim_14x3x2.5_exp2_5x10x100_srs_1x10x100_10x10.csv", header = TRUE, row.names = 1, stringsAsFactors = FALSE)
```
...
exp_names = tibble(experiment = c(1,2), 
                   ...
                   n_sp = c("4", str_c(as.character(n_sp_vec), collapse = ",")), 
...
```{r}
exp_combined = f_combine(data1 = exp1_cleaned, data2 = exp2_cleaned, exp1_param = 4, exp2_param = "srs")
```
